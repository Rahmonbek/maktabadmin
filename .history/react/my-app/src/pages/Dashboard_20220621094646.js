    ...
    getSchool = () => {
        axios
            ...
            .then((res) => {
                this.setState({
                    school: res.data,
                    params: [Number(res.data.params[0]),Number(res.data.params[0])],
            ...
            <div>
                {this.state.loading === true ? (
                    ...
                    <div>
                        ...
                        >
                            <h4 style={{ textAlign: "center", margin: "0", padding: "0.5em 0" }}>
                                Maktab joylashgan manzilni kiriting
                            </h4>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.address : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                            ...
                                            <Form.Group className="mb-3">
                                                ...
                                                {this.state.selectA ? (
                                                    <select
                                                        ...
                                                        name="type"
                                                        type="text"
                                                        value={!this.state.images.type ? "" : this.state.images.type}
                                                        onChange={(e) => this.customText(e)}
                                                    >
                                                        ...
                                                        <option value="Ayrim fanlar chuqur o'rganiladigan ixtisoslashtirilgan davlat umumiy o'rta ta'lim maktabi">
                                                            Ayrim fanlar chuqur o'rganiladigan ixtisoslashtirilgan
                                                            davlat umumiy o'rta ta'lim maktabi
                                                        </option>
                                                    ...
                                                    <select
                                                        ...
                                                        name="type"
                                                        type="text"
                                                        value={this.state.school !== null ? this.state.school.type : ""}
                                                        onChange={(e) => {
                                                            this.customText(e);
                                                        }}
                                                    >
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab veb sahifasining ssilkasini kiriting
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="instagram"
                                                    type="url"
                                                    defaultValue={this.state.domain !== null ? this.state.domain : ""}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="url"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.instagram : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab telefon raqamini kiriting
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="phone"
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.phone : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="url"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.video : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining bosh qismidagi 1-rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining bosh qismidagi 2-rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining bosh qismidagi 3-rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining bosh qismidagi 4-rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining bosh qismidagi 5-rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining tadbirlari va qadriyatlari
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_tq"
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.m_h_tq : ""
                                                    }
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining Navruz bayrami rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining Mustaqillik bayrami
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining Bitiruv bayrami rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasining transport xizmati uchun rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    name="m_h_t_t"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.m_h_t_t : ""
                                                    }
                                                    as="textarea"
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi 306 gradusli rasm uchun sarlavha
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_k_h"
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.m_h_k_h : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi 306 gradusli rasm uchun matn
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_k_t"
                                                    ...
                                                    style={{ height: "100px" }}
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.m_h_k_t : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi oshxona rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi oshxona matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_oshxona_t"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi musiqa rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi musiqa matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_musiqa_t"
                                                    ...
                                                    style={{ height: "100px" }}
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.m_h_musiqa_t : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi sport rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi sport matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_sport_t"
                                                    ...
                                                    style={{ height: "100px" }}
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.m_h_sport_t : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi axborot rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi axborot matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_axborot_t"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi xavfsizlik rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi xavfsizlik matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi tibbiyot rasmi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidagi tibbiyot matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_tibbiyot_t"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidaning oxirdagi mashhur inson rasm
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    accept=".jpg, .jpeg, .png"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidaning oxirdagi mashhur inson matni
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_o"
                                    ...
                                    <Row style={{ marginTop: "20px" }}>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                >
                                                    Maktab hayoti sahifasidaning oxirdagi mashhur inson ismi
                                                </Form.Label>
                                                <Form.Control
                                                    className="formInput"
                                                    name="m_h_o_t"
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    name="q_t"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_t : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    as="textarea"
                                                    style={{ height: "100px" }}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_talim : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                                    onChange={(e) => this.customText(e)}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_bitiruv : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                                    onChange={(e) => this.customText(e)}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_oquvchi : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                                    onChange={(e) => this.customText(e)}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_j_online : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                                    onChange={(e) => this.customText(e)}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    name="q_j_forma"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_j_forma : ""
                                                    }
                                                    as="textarea"
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_j_koz : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                                    onChange={(e) => this.customText(e)}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_j_hujjat : ""
                                                    }
                                                    placeholder="Matn kiriting..."
                                                    style={{ height: "100px" }}
                                                    onChange={(e) => this.customText(e)}
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    as="textarea"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_j_intervyu : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    placeholder="Matn kiriting..."
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_j_qaror : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    style={{ height: "100px" }}
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_imtihon_t : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_oquv_yili : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_muddat : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_imtihon : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_hujjat_t1 : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_hujjat_t2 : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
                                        ...
                                        >
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    type="text"
                                                    defaultValue={
                                                        this.state.school !== null ? this.state.school.q_hujjat_t3 : ""
                                                    }
                                                    onChange={(e) => this.customText(e)}
                                                />
                                            </Form.Group>
