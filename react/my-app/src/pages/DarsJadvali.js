...
export default class DarsJadvali extends Component {
    ...
    render() {
        ...
        <div className={styles.formAdmin}>
            ...
            <a href="#2"><Button variant="primary" className={styles.inputFormBtn} onClick={this.saveJadval}>
                          ...
                          <div className={styles.timetable}>
                            {
                              ...
                              return(
                                ...
                                <h1>{item.sinf} <AiOutlineEdit onClick={()=>this.editDars(key)} style={{fontSize:'20px',color:'green',cursor:'pointer'}}/> <AiOutlineDelete style={{fontSize:'20px',color:'red',cursor:'pointer'}} onClick={()=>this.deleteDars(key)}/></h1> 
