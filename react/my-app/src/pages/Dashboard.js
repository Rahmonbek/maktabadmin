                      ...
                      <Form.Group className="mb-3">
                        ...
                        {this.state.selectA ? (
                          ...
                          >
                            ...
                            <option value="Xususiy maktab">
                              Xususiy maktab
                            </option>
                            <option value="Prezident maktabi">
                              Prezident maktabi
                            </option>
                          </select>
                        ) : (
                  ...
                  <Row style={{ marginTop: "20px" }}>
                    ...
                    >
                      <Form.Group className="mb-3">
                        ...
                        >
                          Maktab hayoti sahifasining transport xizmati uchun
                          rasm
                        </Form.Label>
                        <Form.Control
                          className="formInput"
                  ...
                  <Row style={{ marginTop: "20px" }}>
                    ...
                    >
                      <Form.Group className="mb-3">
                        ...
                        >
                          Maktab hayoti sahifasidagi 306 gradusli rasm uchun
                          sarlavha
                        </Form.Label>
                        <Form.Control
                          className="formInput"
                  ...
                  <Row style={{ marginTop: "20px" }}>
                    ...
                    >
                      <Form.Group className="mb-3">
                        ...
                        >
                          Maktab hayoti sahifasidaning oxirdagi mashhur inson
                          rasm
                        </Form.Label>
                        <Form.Control
                          className="formInput"
