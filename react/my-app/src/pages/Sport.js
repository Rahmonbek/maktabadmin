    ...
    render() {
        return (
            <div>
                <Container fluid>
                    <Row>
                        <h1 style={{ fontSize: "30px", fontFamily: '"Lobster",cursive', display: "inline-block", marginRight: "30px" }}>
                            Sport mashg'ulotlari{" "}
                            <Button onClick={this.showModal} style={{ marginLeft: "30px", backgroundColor: "#187CC0", border: "none" }}>
                                Qo'shish
                            </Button>
                        </h1>
                        {this.state.teachers.map((item, key) => {
                            return (
                                <Col lg={4} md={12} sm={12} style={{ marginTop: "20px" }}>
                                            ...
                                            return (
                                                <Col xl={4} lg={6} md={6} sm={6} className={styles.containerKonkurslar}>
                                                    <div className={styles.cardsKonkurslar}>
                                                        ...
                                                        <span>
                                                            <AiOutlineEdit style={{ marginRight: "5px", color: "green", fontSize: "20px" }} onClick={() => this.editSport(key)} />
                                                        </span>

                                                        <span>
                                                            <AiOutlineDelete style={{ color: "red", fontSize: "20px" }} onClick={() => this.deleteSport(key)} />
                                                        </span>
                                                    </div>
                                                </Col>
                                            );
                ...
                <Modal title="Modal" visible={this.state.visible} onOk={this.hideModal} onCancel={this.hideModal} footer={false}>
                    <Form id="formAdmin">
                        ...
                        <a href="#2">
                            <Button variant="primary" className={styles.inputFormBtn} onClick={this.saveTeacher1}>
                                O'zgarishlarni saqlash
                            </Button>
                        </a>
