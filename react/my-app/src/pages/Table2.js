...
function Table2() {
  const [state, dispatch] = useReducer(reducer, makeData1());
      ...
      <div style={{ overflow: "auto", display: "flex" }}>
        ...
        >
          <Table
            ...
            style={{marginTop:'-100px',boxShadow: '0 0.46875rem 2.1875rem rgb(4 9 20 / 3%), 0 0.9375rem 1.40625rem rgb(4 9 20 / 3%), 0 0.25rem 0.53125rem rgb(4 9 20 / 5%), 0 0.125rem 0.1875rem rgb(4 9 20 / 3%)'}}
          />
        </div>
      </div>
    </div>
