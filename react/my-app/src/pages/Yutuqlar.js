...
export default class Yutuqlar extends Component {
    state={
        ...
        teachers:[
            {
                name:'hbfh3rbfkuhqb3rfu',
                yutuq:'jbghbehbrhb',
                orin:'rfbygb',
                rasm:<img src={rasm} style={{width:'200px'}}/>
            }
        ],
        ustoz:'rgbw',
    }
        ...
        return (
            <div>
                <Container fluid>
                  <Row>
                      <Col lg={12} id="1">
                          <h1 style={{fontSize:'30px',marginLeft:'10px'}} className={styles.adminTop}>Yutuqlar</h1>
                          <Row>
                              <Col lg={12}>
            ...
            <Form.Group controlId="yutuq">
              <Form.Control type="text" placeholder="Yutuq kiriting" defaultValue={this.state.teacher1.yutuq}/>
            </Form.Group>
            <Form.Group  controlId="orin">
              <Form.Control type="text" placeholder="O'rinni kiriting" defaultValue={this.state.teacher1.orin}/>
            </Form.Group>
            <Form.Group  controlId="rasm">
              <Form.Control  type="file" placeholder="Rasm kiriting" defaultValue={this.state.teacher1.rasm}/>
            </Form.Group>
